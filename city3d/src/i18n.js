...
const DICTS = {
  de: {
    ...
    'legend.violUp': 'Verstoß: Level steigt (aufwärts)',
    ...
    'pod.violUp': 'Verstoß: Level steigt',
    'pod.ok': 'regelkonform',
    'pod.way': 'Weg',
  ...
  en: {
    ...
    'legend.violUp': 'violation: level rises (upward)',
    ...
    'pod.violUp': 'violation: level rises',
    'pod.ok': 'compliant',
    'pod.way': 'path',
  ...
  pt: {
    ...
    'legend.violUp': 'violação: nível sobe (para cima)',
    ...
    'pod.violUp': 'violação: nível sobe',
    'pod.ok': 'conforme',
    'pod.way': 'percurso',
