...
public sealed interface Element {
    ...
    record ClassElement(String fqn, int architectureLevel) implements Element {
        public ClassElement {
     ...
     */
    record PackageElement(String fqn, int architectureLevel, List<List<Element>> rows) implements Element {
