...
public final class TarjanSCCFinder implements SCCFinder {
    ...
    @Override
    public List<StronglyConnectedComponent> findSCCs(Map<String, Set<String>> graph) {
        return new Run(graph).findSCCs();
    }
    ...
    private static final class Run {
        ...
        private Run(Map<String, Set<String>> graph) {
            this.graph = graph;
            int n = graph.size();
         ...
         */
        private List<StronglyConnectedComponent> findSCCs() {
