 ...
 * extrahiert.
 */
final class TangleOverlayController {
    ...
    void setVisualization(List<DependencyEdge> edges, String selectedFrom, String selectedTo) {
    ...
    Set<DependencyEdge> getCycleBreakEdges() {
        return cycleBreakEdges;
    }

    void setCycleBreakEdges(Set<DependencyEdge> edges) {
    ...
    void setAppliedCutEdges(Set<DependencyEdge> cuts) {
    ...
    void applyEdgeCut(String from, String to) {
    ...
    void applyEdgeCuts(Collection<DependencyEdge> cuts) {
    ...
    void restoreEdgeCut(String from, String to) {
        if (from == null || to == null) {
            return;
        }
        DependencyEdge cut = new DependencyEdge(from, to);
    ...
    void setOnEdgeClicked(BiConsumer<String, String> sink) {
        this.edgeClickedSink = sink == null ? (a, b) -> {} : sink;
    }

    void setOnEdgeCut(BiConsumer<String, String> sink) {
        this.edgeCutSink = sink == null ? (a, b) -> {} : sink;
    }

    void setOnEdgeRestore(BiConsumer<String, String> sink) {
