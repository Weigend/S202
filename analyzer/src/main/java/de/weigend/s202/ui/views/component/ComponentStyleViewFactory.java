...
/** Registriert die Component-Ansicht am StyleView-SPI. */
@Singleton
public final class ComponentStyleViewFactory implements StyleViewFactory {

    @Inject
    ComponentStyleViewFactory() {
    }
    ...
    public StyleView create(ViewServices services) {
        return new ComponentStyleView(services);
    }
}
