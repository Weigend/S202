...
atribu\'idos, S202 aplica o mesmo algoritmo de rank-score de forma independente
dentro de cada cont\^einer pai. Um grafo ponderado somente entre irm\~aos dos
filhos diretos \'e constru\'ido e um \emph{localLevel} \'e derivado para cada
elemento. O localLevel controla o posicionamento visual dentro do cont\^einer
...
\begin{enumerate}
  ...
  \item \textbf{Atribuir posi\c{c}\~oes locais de exibi\c{c}\~ao:} Ap\'os a
        ...
        o mesmo algoritmo de rank-score quebra eventuais ciclos; o caminho mais
        longo produz um \emph{localLevel} por filho. O \emph{localLevel}
