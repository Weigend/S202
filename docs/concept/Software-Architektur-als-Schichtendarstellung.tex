...
1960er- und Anfang der 1970er-Jahre wird Software-Architektur als
...
eigenen Vergleichsknoten. Sie liefern nur die Information f\"ur die Aggregation:
Eine Klassenabh\"angigkeit wird auf die Kindpakete hochgerollt, in deren
Teilb\"aumen Quelle und Ziel liegen.

F\"ur jedes Parent-Paket entsteht so ein eigener Geschwistergraph seiner
Kindpakete. Die Kanten in diesem Graphen sind Paketabh\"angigkeiten zwischen
diesen Kindpaketen. Wenn eine Klasse im Teilbaum von Kindpaket $P$ eine Klasse
im Teilbaum von Kindpaket $Q$ benutzt, entsteht eine Kante $P \to Q$. Ihr
Gewicht ist die Anzahl der konkreten Nutzungen, die auf diese Paketkante
hochgerollt werden; f\"ur strukturelle Abh\"angigkeiten ohne Aufrufz\"ahlung
wird ein Gewicht von~1 verwendet. Die Gegenrichtung wird ebenfalls gez\"ahlt.
...
Das Rangma\ss{} bewertet f\"ur jedes Kindpaket, ob es im aktuellen
Geschwistergraphen eher andere Pakete nutzt oder eher von ihnen genutzt wird.
Im Paketgraphen wird es aus gewichteten Paketkanten berechnet:
...
Eine Kante wird erst dann als Bruch dieser Ordnung behandelt, wenn der
Rangunterschied gr\"o\ss{}er als eine Schwelle $\varepsilon$ ist. In S202 wird
daf\"ur aktuell $\varepsilon = 0{,}1$ verwendet. Liegen zwei Pakete zu nah
beieinander, bleiben sie konzeptionell Peers und damit auf demselben Level. Ein
gegenseitiges Aufrufverh\"altnis von $100 : 101$ ist deshalb keine belastbare
