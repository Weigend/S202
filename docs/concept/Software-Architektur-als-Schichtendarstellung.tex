...
\begin{enumerate}
  ...
  \item Bei zyklischen Abh\"angigkeiten muss der Zyklus f\"ur die
        ...
        unver\"andert; ver\"andert wird der daraus abgeleitete DAG
...
Eine SCC (\emph{Strongly Connected Component}, stark zusammenh\"angende
Komponente) ist dabei eine Menge von Knoten, in der jeder Knoten jeden anderen
...
\begin{figure}[H]
  ...
  \caption{Zyklischer S202-Ausschnitt. Die gestrichelten Kanten sind Verletzungen:
...
Die Begriffe Back-Edge, Verletzung und CUT beschreiben unterschiedliche Rollen:
...
\begin{description}
  ...
  \item[Verletzung] Eine konkrete Abh\"angigkeit, die nach der berechneten
        ...
        nicht. Im Beispiel sind alle sichtbaren Verletzungen zugleich
        Back-Edges; begrifflich bleibt eine Verletzung aber die sichtbare
        Ordnungsabweichung, w\"ahrend eine Back-Edge die Rolle der Kante in der
        Zyklusbehandlung beschreibt.
  \item[CUT] Eine vom Benutzer markierte geplante Trennung eines konkreten
        Methodenaufrufs. Ein CUT ist keine automatische Layoutentscheidung,
        sondern ein Refactoring-Vorschlag, dessen Wirkung auf die SCC gepr\"uft
        wird.
\end{description}
...
Architekturhypothese als hierarchische Schichtendarstellung: Klassenabh\"angigkeiten liefern den Graphen,
