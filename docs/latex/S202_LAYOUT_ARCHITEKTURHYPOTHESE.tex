...
sichtbar. Nachbedingungen dienen anschliessend als implementierungsneutrale,
...
\section{Nachbedingungen als ausf\"uhrbare Spezifikation}

Nachbedingungen waren in der Entwicklung von S202 nicht nur Testcode. Sie waren
...
sichtbare Reihenfolge. Die Nachbedingungen werden danach gepr\"uft. Sie
...
Der Vorteil dieser Formulierung liegt in der Redundanz. Eine Nachbedingung muss
...
\begin{enumerate}
  ...
  \item Die fertige Grafik durch Nachbedingungen pr\"ufen (R1--R4).
\end{enumerate}
