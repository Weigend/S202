...
%%
%% Status: WORKING DRAFT -- German text, pending:
%%   (1) English translation
%%   (2) Co-author approval (Veronika Schwarz, Michael Philippsen)
...
\author{
  ...
  \affiliation{Technische Hochschule Rosenheim / QAware GmbH, Germany}
  \email{johannes.weigend@gmail.com}
  \authorname{Veronika Schwarz}
  \affiliation{TBD}%          % formerly published as Veronika Dashuber
  \email{TBD}
