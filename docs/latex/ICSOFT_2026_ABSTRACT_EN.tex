...
postconditions for exactly this pipeline separation. The checker found a real R2 bug in \emph{software-ekg-7}, showing that the
rules are not trivial to satisfy, even for the authors of the algorithm.
...
must be removed or inverted to eliminate the most cycles with the least refactoring effort.
