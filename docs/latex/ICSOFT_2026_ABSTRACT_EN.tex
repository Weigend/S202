...
degree of machine-checkable self-validation.}
%% ---------------------------------------------------------------
...
Phase~1 produces classpath-independent results because SCCs are collapsed before levels are assigned.
...
Throughout the iterative development of the level pipeline, R2 surfaced
